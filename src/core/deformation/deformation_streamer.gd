...
func _ready():
	Log.info("deformation", "DeformationStreamer: Streamer initialized")
...
func _on_terrain_region_loaded(region_coord: Vector2i):
	Log.debug("deformation", "DeformationStreamer: Terrain region loaded: %s" % region_coord)
	request_load_region(region_coord)

# Terrain region unloaded callback
func _on_terrain_region_unloaded(region_coord: Vector2i):
	Log.debug("deformation", "DeformationStreamer: Terrain region unloaded: %s" % region_coord)

...
## Ported from OpenMW components/esm3/loadprob.hpp
class_name ProbeRecord
extends ESMRecord
...
static func get_record_type() -> int:
	return ESMDefs.RecordType.REC_PROB
...
func _to_string() -> String:
	return "Probe('%s', quality=%.2f)" % [record_id, quality]

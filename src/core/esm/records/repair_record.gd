## Repair Item Record (REPA)
## Repair hammers/tools for fixing equipment
## Ported from OpenMW components/esm3/loadrepa.hpp
class_name RepairRecord
extends ESMRecord
...
static func get_record_type() -> int:
	return ESMDefs.RecordType.REC_REPA
...
func _to_string() -> String:
	return "RepairItem('%s', quality=%.2f)" % [record_id, quality]

...
const MORROWIND_ANIM_MAP: Dictionary = {
	...
	&"WalkBack": ["walkback", "WalkBack", "walk_back"],
	&"WalkLeft": ["walkleft", "WalkLeft", "walk_left"],
	&"WalkRight": ["walkright", "WalkRight", "walk_right"],
	&"WalkForwardLeft": ["walkforwardleft", "WalkForwardLeft", "walk_forward_left", "walkleft", "WalkLeft"],
	&"WalkForwardRight": ["walkforwardright", "WalkForwardRight", "walk_forward_right", "walkright", "WalkRight"],
	&"WalkBackLeft": ["walkbackleft", "WalkBackLeft", "walk_back_left", "walkleft", "WalkLeft", "walkback", "WalkBack"],
	&"WalkBackRight": ["walkbackright", "WalkBackRight", "walk_back_right", "walkright", "WalkRight", "walkback", "WalkBack"],
	&"Run": ["runforward", "RunForward", "run"],
	&"RunBack": ["runback", "RunBack", "run_back"],
	&"RunLeft": ["runleft", "RunLeft", "run_left"],
	&"RunRight": ["runright", "RunRight", "run_right"],
	&"RunForwardLeft": ["runforwardleft", "RunForwardLeft", "run_forward_left", "runleft", "RunLeft"],
	&"RunForwardRight": ["runforwardright", "RunForwardRight", "run_forward_right", "runright", "RunRight"],
	&"RunBackLeft": ["runbackleft", "RunBackLeft", "run_back_left", "runleft", "RunLeft", "runback", "RunBack"],
	&"RunBackRight": ["runbackright", "RunBackRight", "run_back_right", "runright", "RunRight", "runback", "RunBack"],
	&"Sprint": ["runforward", "RunForward", "run"],  # MW has no sprint — use run at faster playback
	&"Jump": ["jump", "Jump"],
	&"Fall": ["jumploop", "JumpLoop"],
	&"Land": ["jumpland", "JumpLand"],
	&"Crouch": ["sneakidle", "SneakIdle", "sneak"],
	&"CrouchWalk": ["sneakforward", "SneakForward", "sneak"],
	&"CrouchBack": ["sneakback", "SneakBack", "sneakbackward", "crouchback", "CrouchBack"],
	&"SneakForward": ["sneakforward", "SneakForward", "sneak_forward"],
	&"SneakBack": ["sneakback", "SneakBack", "sneak_back"],
	&"SneakLeft": ["sneakleft", "SneakLeft", "sneak_left"],
	&"SneakRight": ["sneakright", "SneakRight", "sneak_right"],
	&"SneakForwardLeft": ["sneakforwardleft", "SneakForwardLeft", "sneak_forward_left", "sneakleft", "SneakLeft"],
	&"SneakForwardRight": ["sneakforwardright", "SneakForwardRight", "sneak_forward_right", "sneakright", "SneakRight"],
	&"SneakBackLeft": ["sneakbackleft", "SneakBackLeft", "sneak_back_left", "sneakleft", "SneakLeft", "sneakback", "SneakBack"],
	&"SneakBackRight": ["sneakbackright", "SneakBackRight", "sneak_back_right", "sneakright", "SneakRight", "sneakback", "SneakBack"],
	&"SwimIdle": ["swimidle", "SwimIdle"],
	&"SwimForward": ["swimforward", "SwimForward"],
	&"SwimWalkForward": ["swimwalkforward", "SwimWalkForward", "swim_walk_forward"],
	&"SwimWalkBack": ["swimwalkback", "SwimWalkBack", "swim_walk_back"],
	&"SwimWalkLeft": ["swimwalkleft", "SwimWalkLeft", "swim_walk_left"],
	&"SwimWalkRight": ["swimwalkright", "SwimWalkRight", "swim_walk_right"],
	&"SwimWalkForwardLeft": ["swimwalkforwardleft", "SwimWalkForwardLeft", "swim_walk_forward_left", "swimwalkleft", "SwimWalkLeft"],
	&"SwimWalkForwardRight": ["swimwalkforwardright", "SwimWalkForwardRight", "swim_walk_forward_right", "swimwalkright", "SwimWalkRight"],
	&"SwimWalkBackLeft": ["swimwalkbackleft", "SwimWalkBackLeft", "swim_walk_back_left", "swimwalkleft", "SwimWalkLeft", "swimwalkback", "SwimWalkBack"],
	&"SwimWalkBackRight": ["swimwalkbackright", "SwimWalkBackRight", "swim_walk_back_right", "swimwalkright", "SwimWalkRight", "swimwalkback", "SwimWalkBack"],
	&"SwimRunForward": ["swimrunforward", "SwimRunForward", "swim_run_forward"],
	&"SwimRunBack": ["swimrunback", "SwimRunBack", "swim_run_back"],
	&"SwimRunLeft": ["swimrunleft", "SwimRunLeft", "swim_run_left"],
	&"SwimRunRight": ["swimrunright", "SwimRunRight", "swim_run_right"],
	&"SwimRunForwardLeft": ["swimrunforwardleft", "SwimRunForwardLeft", "swim_run_forward_left", "swimrunleft", "SwimRunLeft"],
	&"SwimRunForwardRight": ["swimrunforwardright", "SwimRunForwardRight", "swim_run_forward_right", "swimrunright", "SwimRunRight"],
	&"SwimRunBackLeft": ["swimrunbackleft", "SwimRunBackLeft", "swim_run_back_left", "swimrunleft", "SwimRunLeft", "swimrunback", "SwimRunBack"],
	&"SwimRunBackRight": ["swimrunbackright", "SwimRunBackRight", "swim_run_back_right", "swimrunright", "SwimRunRight", "swimrunback", "SwimRunBack"],

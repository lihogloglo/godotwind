...
func _setup_boujie_experimental_defaults() -> void:
	...
	_material.set_shader_parameter("refraction_weather_visibility", 1.0)
	_material.set_shader_parameter("refraction_optical_fade_power", 1.35)
	_material.set_shader_parameter("refraction_extinction_blur_lod", 3.0)

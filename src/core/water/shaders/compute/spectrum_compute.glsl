 ...
 * with Hasselmann directional spreading.
 *
...
// Samples a 2D-bivariate normal distribution using Box-Muller transform
...
// TMA spectrum (JONSWAP with depth attenuation)
// Source: Christopher J. Horvath - Empirical Directional Wave Spectra for Computer Graphics
...
void main() {
	...
	// Pack the spectra at both k and -k for use in the modulation stage

# Humanoid Equipment System
# Simpler than MW body parts - uses standard humanoid attachment points
# Equipment attaches to bones via BoneAttachment3D
#
# Usage:
#   var equipment := HumanoidEquipment.new()
#   equipment.attach(character, "weapon_r", "res://sword.glb", "RightHand")

class_name HumanoidEquipment
extends RefCounted

## Standard attachment bone names for humanoid skeleton

...
Working: ground locomotion (idle/walk/run/sprint/crouch), jump/midair, swimming.
Planned: stagger/interrupt (Phase 4), basic climbing (Phase 5), flying toggle (Phase 6).

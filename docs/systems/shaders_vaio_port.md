...
- **DIVE underwater effects** — caustics, underwater light shafts, backscattering, phytoplankton. This page no longer describes current ocean/underwater ownership; use `docs/systems/ocean/architecture.md` and `docs/systems/ocean/godot_4_6_water_rendering_rules.md` for the active Godotwind water path.
